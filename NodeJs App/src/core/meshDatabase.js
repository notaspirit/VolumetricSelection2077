...
async function initializeMeshDatabaseLocal() {
    const appPath = await ipcRenderer.invoke('get-app-path');
    const dbPath = path.join(appPath, 'cache','meshDatabase.db');
...
class MeshDatabase {
    async initialize() {
        return await initializeMeshDatabaseLocal();
    }
...
const meshDB = new MeshDatabase();
module.exports = meshDB;
