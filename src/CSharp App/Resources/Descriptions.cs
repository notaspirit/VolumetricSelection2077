namespace VolumetricSelection2077.Resources
{
        public static class ToolTips
        {
            ...
            public static string CustomSelectionFilePath { get; } = "Path to the custom selection file location (e.g. MO2's overwrite folder). The same file structure as found in the game directory is expected. If selection file is in the game directory leave this blank.";
        }
