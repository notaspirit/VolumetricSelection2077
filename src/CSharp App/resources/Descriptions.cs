namespace VolumetricSelection2077.Resources
{
    public class Descriptions
    {
        ...
        public string AllowOverwriteTooltip { get; set; } = "Allow overwriting the output file if one with the same name already exists, when extending output file is enabled this setting doesn't do anything";
    }
}